...
#define DUNE_REGISTER_DIRECT_SOLVER(name, ...)                \
  DUNE_ISTL_REGISTRY_PUT(DirectSolverTag, name, __VA_ARGS__)

#define DUNE_REGISTER_PRECONDITIONER(name, ...)                \
  DUNE_ISTL_REGISTRY_PUT(PreconditionerTag, name, __VA_ARGS__)

#define DUNE_REGISTER_ITERATIVE_SOLVER(name, ...)                \
  DUNE_ISTL_REGISTRY_PUT(IterativeSolverTag, name, __VA_ARGS__)
