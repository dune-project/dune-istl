...
namespace
{
  ...
  using Solver = Dune::RCGSolver<BVector,BVector,Dune::KrylovTerminationCriterion::ResidualBased>;


  struct TestRCG_ResidualBasedTermination : ::testing::Test
  {
    TestRCG_ResidualBasedTermination()
      : mat(),
        A( mat )
    {}
...
TEST_F(TestRCG_ResidualBasedTermination, Laplacian)
{
  BVector b(N*N), x(N*N);
