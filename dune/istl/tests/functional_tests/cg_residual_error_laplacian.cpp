...
namespace
{
  ...
  using Solver = Dune::CGSolver<BVector,BVector,Dune::KrylovTerminationCriterion::ResidualBased>;


  struct TestCG_ResidualBasedTermination : ::testing::Test
  {
    TestCG_ResidualBasedTermination()
      : mat(),
        A( mat )
    {}
...
TEST_F(TestCG_ResidualBasedTermination, Laplacian)
{
  BVector b(N*N), x(N*N);
