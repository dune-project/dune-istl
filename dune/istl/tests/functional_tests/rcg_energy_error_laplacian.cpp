...
namespace
{
  ...
  using Solver = Dune::RCGSolver<BVector>;


  struct TestRCG_EnergyErrorTermination : ::testing::Test
  {
    TestRCG_EnergyErrorTermination()
      : mat(),
        A( mat )
    {}
...
TEST_F(TestRCG_EnergyErrorTermination, Laplacian)
{
  BVector b(N*N), x(N*N);
