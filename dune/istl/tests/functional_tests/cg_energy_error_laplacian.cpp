...
namespace
{
  ...
  using Solver = Dune::CGSolver<BVector>;


  struct TestCG_EnergyErrorTermination : ::testing::Test
  {
    TestCG_EnergyErrorTermination()
      : mat(),
        A( mat )
    {}
...
TEST_F(TestCG_EnergyErrorTermination, Laplacian)
{
  BVector b(N*N), x(N*N);
