...
namespace Dune
{
  ...
  public:
    ...
    ColCompMatrixInitializer(ColCompMatrix& lum,
                             typename std::enable_if_t<Dune::IsNumber<typename M::block_type>::value>* sfinae = nullptr);
  ...
  template<class M>
  ColCompMatrixInitializer<M>::ColCompMatrixInitializer(ColCompMatrix& mat_,typename std::enable_if_t<Dune::IsNumber<typename M::block_type>::value>* sfinae)
