...
void testMultiVector(const Dune::MultiTypeBlockVector<Args...>& multiVector)
{
    // test operator<<
    ...
    static_assert(std::decay_t<decltype(multiVector)>::size()==2, "Method MultiTypeBlockVector::size() returned wrong value!");
